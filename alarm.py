...
def belief_networks_alarm():
    ...
    n01_1 = alarm_infer.query(variables=['MaryCalls'], evidence={'JohnCalls':'yes'})
    n01_2 = alarm_infer.query(variables=['JohnCalls', 'MaryCalls'], evidence={'Alarm': 'yes'})
    n01_3 = alarm_infer.query(variables=['Alarm'], evidence={'MaryCalls': 'yes'})
